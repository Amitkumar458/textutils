    ...
    return (
        <>
            ...
            <div style={{ color: props.mode === "light" ? "black" : "white" }}>
                ...
                <h3>Edit Texts</h3>
                <button disabled={text.length === 0} className='btn btn-danger mx-1 my-1' onClick={handelupclick}>Convert to Uppercase</button>
                <button disabled={text.length === 0} className='btn btn-primary mx-1 my-1' onClick={handellowclick}>Convert to Lowercase</button>
                <button disabled={text.length === 0} className='btn btn-info mx-1 my-1' onClick={handelcapitalfirstclick}>Capital first letter</button>
                <button disabled={text.length === 0} className='btn btn-warning mx-1 my-1' onClick={handelreplaceextraspaceclick}>Remove Extra space</button>
                <button disabled={text.length === 0} className='btn btn-success mx-1 my-1' onClick={handelcopyclick}>Copy</button>
                <button disabled={text.length === 0} className='btn btn-secondary mx-1 my-1' onClick={handelclearclick}>Clear text</button>
            </div>
